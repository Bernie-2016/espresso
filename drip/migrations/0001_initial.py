    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drip', models.ForeignKey(related_name='send_drips', to='drip.Drip')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_email', models.EmailField(default=None, max_length=75, null=True)),
                ('from_email_name', models.CharField(default=None, max_length=150, null=True)),
                ('drip', models.ForeignKey(related_name='sent_event_drips', to='drip.Drip')),
                ('event', models.ForeignKey(related_name='sent_event_drips', to='ground_control.BsdEvents')),
            ],
            options={
            },
            bases=(models.Model,),
