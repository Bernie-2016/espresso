...
def get_fields(Model, 
    ...
    fields = Model._meta.get_fields() # Model._meta.fields + Model._meta.many_to_many + ImmutableList(Model._meta.get_all_related_objects())
...
def get_user_model():
    return django_apps.get_model(settings.DRIP_USER_MODEL)
